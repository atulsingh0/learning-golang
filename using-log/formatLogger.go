...
func init() {
	...
	warnLogger = log.New(file, fmt.Sprintf("%9s", "WARNING: "), log.Ldate|log.Ltime|log.Lshortfile)
	errLogger = log.New(file, fmt.Sprintf("%9s", "ERROR: "), log.Ldate|log.Ltime|log.Lshortfile)
